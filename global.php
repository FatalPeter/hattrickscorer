...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li class="active"><a href="global.php?id=<?php echo $userCode; ?>"><i class="far fa-clipboard"></i> General</a></li>
			...
			<div class="container global">
				...
				<div class="row">
					...
					<div class="controls">
						...
						<div class="scorer_control scorer_active" id="official_res" onclick="showResults(this,'ufficiali')">Official match</div>
						<div class="scorer_control" id="all_res" onclick="showResults(this,'tutti')">All match</div>
					</div>
					
					<div class="controls">
						<div class="scorer_category">Competition</div>
						<div class="scorer_control" id="league_res" onclick="showResults(this,'campionato')">League match</div>
						<div class="scorer_control" id="cup_res" onclick="showResults(this,'coppa')">Cup match</div>
						<div class="scorer_control" id="friendly_res" onclick="showResults(this,'amichevole')">Friendly match</div>
						<div class="scorer_control" id="masters_res" onclick="showResults(this,'masters')">Masters match</div>					
					</div>
					
					<div class="loading_gears" id="loading_gears_1">
						<img src="images/gears_inverted.svg" />
					</div>								
					<div class="scorer_tables" id="result_append">
				...
				<div class="row">
					...
					<div class="controls">
						<div class="scorer_category">Global</div>
						<div class="scorer_control scorer_active" id="official_cap" onclick="showCaptains(this,'ufficiali')">Official match</div>
						<div class="scorer_control" id="all_cap" onclick="showCaptains(this,'tutti')">All match</div>
					</div>
					
					<div class="controls">
						<div class="scorer_category">Competition</div>
						<div class="scorer_control" id="league_cap" onclick="showCaptains(this,'campionato')">League match</div>
						<div class="scorer_control" id="cup_cap" onclick="showCaptains(this,'coppa')">Cup match</div>
						<div class="scorer_control" id="friendly_cap" onclick="showCaptains(this,'amichevole')">Friendly match</div>
						<div class="scorer_control" id="masters_cap" onclick="showCaptains(this,'masters')">Masters match</div>					
					</div>
					
					<div class="loading_gears" id="loading_gears_2">
						<img src="images/gears_inverted.svg" />
					</div>								
					<div class="scorer_tables" id="captains_append">
	...
	<!-- funzioni di utilità -->
	<input type="hidden" id="current_active_res" value="official_res" />
	<input type="hidden" id="current_request_res" value="ufficiali" />
	
	<input type="hidden" id="current_active_cap" value="official_cap" />
	<input type="hidden" id="current_request_cap" value="ufficiali" />
